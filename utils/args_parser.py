def add_default_args(parser):
    ...
    parser.add_argument("--uncertainty_ema", type=float, default=0.9, help="EMA decay for causal under-prediction margins.")
    parser.add_argument("--conditional_fulfill", type=int, default=0, help="Protect cumulative class fulfill ratios with priority hinge objectives.")
    parser.add_argument("--fulfill_slo", type=float, default=0.995, help="Minimum cumulative fulfill ratio used by conditional objectives.")
    parser.add_argument("--cvar_alpha", type=float, default=0.1, help="Worst-sample fraction used by tail-risk losses.")
    parser.add_argument("--cvar_weight", type=float, default=0.0, help="Weight of differentiable tail-risk MLU objectives.")
